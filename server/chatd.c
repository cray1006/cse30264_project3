...
struct client{ //client structure containing address structure, group name, and username
...
int main(int argc, char *argv[]){
	...
	struct client client_list[MAX_CLIENTS]; //array of client structures 
	int i, j;
	for(i = 0; i < MAX_CLIENTS; i++){ //clearing array
